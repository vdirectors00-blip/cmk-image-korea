...
- **정중앙**: nav 메뉴 `About / Consulting / Academy / Community / Contact` (1차 오픈 KO only 라 언어 토글 없음. Image Lab 은 §6.5 갱신 — 인덱스 항상 노출)
...
**이 문서는 v1.3.12이며, 개발 진행 중 발견되는 결정 사항은 본 문서에 추가·갱신함.**
